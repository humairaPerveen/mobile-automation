...
public class BasicTest {
    ...
    private static final String APP = "/home/vend/Downloads/yallahood.apk";
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("deviceName", "sdk_gphone_x86_arm"); //This will change to type of device e.g. Pixel 4 on Saucelabs
        capabilities.setCapability("platformName", "Android");
        capabilities.setCapability("platformVersion","11" ); //add platformVersion
        capabilities.setCapability("automationName", "UiAutomator2");
       capabilities.setCapability("appPackage", "com.example.yallaHood");
